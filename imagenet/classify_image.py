...
def howlikely(tempprob):
  ...
  if tempprob < .3:
    textprobability = "looks a little like a"
  elif tempprob < .5:
    textprobability = "maybe it's a"
  elif tempprob < .75:
    textprobability = "it kinda could be a"
  elif tempprob < .8:
    textprobability = "looks like a"
  elif tempprob < .9:
    textprobability = "I think thats a"
  elif tempprob < .95:
    textprobability = "I'm pretty sure it's a"
  else:
    textprobability = "I see with my little eye a"    
...
def run_inference_on_image(image):
  ...
  with tf.Session() as sess:
    ...
    # ANDY EDITS
    # Build google image search string
    googleimagekeywords = ""
    ...
    for node_id in top_k:
      ...
      googleimagekeywords += human_string + " "

    #print('Google Images Keyword: %s' % googleimagekeywords)
